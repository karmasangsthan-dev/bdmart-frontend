            ...
            <div className="contact-content-hd">
                <div className="contact-cards">
                    <div className="contact-card">
                        ...
                        <h5>Email Us</h5>
                        <p><span>contact@bangladeshmart.com.bd</span> Interactively grow empowered for process-centric total linkage.</p>
                    </div>
                    <div className="contact-card">
                        <span className="logo">
                    ...
                    <div className="contact-card">
                        ...
                        <h5>Location</h5>
                        <p><span onClick={handlePhoneCall}>+12 34567890</span> Basundhara City Complex, Level 1-4, Block-A , Dhaka 1229, Bangladesh.</p>
                    </div>
                </div>
            </div>
        </div>
