...
const ShareProduct = ({ productNo }) => {
    const shareOnFacebook = () => {
        const url = `https://bangladeshmart.com.bd/productDetails/${productNo}`;
        window.open(`https://www.facebook.com/sharer/sharer.php?u=${url}`);
    };
    return (
        <div className="share mt-4 d-lg-block d-sm-none">
            <div className="d-flex align-items-center gap-2 ">
                <p className="mt-1" style={{ fontWeight: '500' }}>Share:</p>
                <ul className="icon-container ps-0 share-icon">
