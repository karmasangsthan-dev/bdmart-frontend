                                            ...
                                            <div className="table-con">
                                                <div className="con">
                                                    <table className='table-order'>
                                                        ...
                                                        <tbody>
                                                            {
                                                                [1, 2, 3, 4, 5, 6, 7, 8].map((order, index) => {
                                                                    return (
                                                                        <tr key={index}>
                                                                            <td className='order-id'><span>9e2a</span></td>
                                                                            <td className='order-date'><span>June 22, 2023</span></td>

                                                                            <td className='order-date'><span>Cash</span></td>
                                                                            <td className='order-date'><span>Pending</span></td>
                                                                            <td className='order-date'><span>171.00</span></td>
                                                                        </tr>
                                                                    )
                                                                })
                                                            }
