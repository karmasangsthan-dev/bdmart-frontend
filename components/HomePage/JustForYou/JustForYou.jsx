...
const JustForYou = () => {
    ...
    const { data, isLoading, refetch } = useGetAllProductsQuery({ perPage: page });
                                    ...
                                    >
                                        ...
                                        <div className="product-details-card p-2">
                                            <div className="product-title">
                                                <span>
                                                    {product?.title?.length > 37 ? `${product?.title.slice(0, 40)} ...` : product?.title}
                                                </span>
                                            </div>
                                            <div className="product-price">
            ...
            <InfiniteScroll
                ...
                endMessage={
                    data?.data && <p style={{ textAlign: 'center' }}>
                        <b>To see more products click <span onClick={() => router.push('/shop')}>here</span></b>
                    </p>
                }
            ></InfiniteScroll>
        </div>
