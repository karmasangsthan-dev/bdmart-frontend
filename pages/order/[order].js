    ...
    <Layout title="Invoice - Bangladesh Mart">
      {1 == 2 ? (
        ...
        <div className="invoice-container" style={{ height: "120vh" }}>
          <div
            className="mx-5 px-5 mt-4 rounded-2 py-2"
            style={{ backgroundColor: "rgb(209 250 229/1)" }}
          >
            {data?.paid === true ? (
              <label>
                Thank you{" "}
                <span style={{ color: "rgb(5 150 105/1)", fontWeight: "700" }}>
            ...
            >
                  ...
                  <tbody>
                    {data?.products?.map((product, i) => (
                      <tr className="" key={i}>
                        ...
                        <td>
                          {product?.price * product?.quantity} {data?.currency}
                        </td>
                      </tr>
                    ))}
                  </tbody>
              ...
              >
                <div>
                  ...
                  <p>
                    {data?.paymentMethod === "cashOnDelevery" &&
                      "Cash on delevery"}
                  </p>
                  <p>
                    {data?.paymentMethod === "onlinePay" && "Online Payment"}
                  </p>
                </div>
                <div>
                  <h6>SHIPPING COST</h6>
